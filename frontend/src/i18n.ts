...
export const translations = {
  it: {
    ...
    setup: {
      ...
      normalizeDesc: 'Equalizza e alza il volume del parlato troppo basso',
      preview: 'Genera Anteprima',
      previewing: 'Generazione in corso...',
      previewOriginal: 'Originale',
      previewNormalized: 'Normalizzato',
      models: {
        tiny: 'Veloce (Tiny)',
    ...
    help: {
      ...
      normalizationTitle: '2. Normalizzazione Audio (Novità)',
      normalizationIntro: 'La funzione di normalizzazione bilancia i volumi dell\'audio, aumentando il volume delle voci sommesse ed evitando che quelle troppo alte distorgano l\'ascolto.',
      normalizationNote: 'Nota: Puoi ascoltare un\'anteprima di 30 secondi nella schermata di configurazione per decidere se attivare il filtro.',
  ...
  en: {
    ...
    setup: {
      ...
      normalizeDesc: 'Equalize and boost very quiet voice volumes',
    ...
    help: {
      ...
      normalizationTitle: '2. Audio Normalization (New)',
      normalizationIntro: 'The normalization feature balances audio volumes, increasing the volume of quiet voices and preventing loud ones from distorting playback.',
      normalizationNote: 'Note: You can listen to a 30-second preview in the setup screen to decide whether to enable the filter.',
